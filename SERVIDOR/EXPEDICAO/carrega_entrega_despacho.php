...
echo "<td class='text-center'><button class='btn btn-success btn-sm' onclick='Processo_envia_entrega_despacho()' id='botao_despachar'><b><i class='fa fa-check' ></i> </b></button></td>";
